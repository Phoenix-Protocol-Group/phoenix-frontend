...
export async function upgrade(
  { new_wasm_hash, contractId }: { new_wasm_hash: Buffer; contractId: string },
  { signAndSend, fee }: { signAndSend?: boolean; fee?: number } = {
    signAndSend: false,
    fee: 100,
  }
...
export async function query_config(
  {
    ...
    signAndSend,
    fee,
  }: { contractId: string; signAndSend?: boolean; fee?: number } = {
    contractId: "",
    signAndSend: false,
    fee: 100,
  }
...
export async function query_share_token_address(
  {
    contractId,
    signAndSend,
    fee,
...
export async function query_pool_info(
  {
    contractId,
    signAndSend,
    fee,
...
export async function simulate_swap(
  {
    contractId,
    sell_a,
    offer_amount,
  }: { contractId: string; sell_a: boolean; offer_amount: i128 },
  { signAndSend, fee }: { signAndSend?: boolean; fee?: number } = {
    signAndSend: false,
    fee: 100,
  }
...
export async function simulate_reverse_swap(
  {
    contractId,
    sell_a,
    ask_amount,
  }: { contractId: string; sell_a: boolean; ask_amount: i128 },
  { signAndSend, fee }: { signAndSend?: boolean; fee?: number } = {
    signAndSend: false,
    fee: 100,
  }
...
export function SimulateSwapResponseFromXdr(
  base64Xdr: string
...
export function SimulateReverseSwapResponseToXdr(
...
export function SimulateReverseSwapResponseFromXdr(
  base64Xdr: string
