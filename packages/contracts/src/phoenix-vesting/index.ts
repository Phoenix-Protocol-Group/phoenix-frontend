 ...
 * Curve types
 */
export type Curve = | { tag: "Constant"; values: readonly [u128] } | {
...
export interface Client {
     ...
     */
    initialize: ({
                     admin, vesting_token, max_vesting_complexity,
                 }: {
        admin: string; vesting_token: VestingTokenInfo; max_vesting_complexity: u32;
    }, options?: {
        /**
     ...
     */
    create_vesting_schedules: ({vesting_schedules}: { vesting_schedules: Array<VestingSchedule> }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
         */
        fee?: number;
     ...
     */
    claim: ({sender, index}: { sender: string; index: u64 }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
         */
        fee?: number;
     ...
     */
    query_balance: ({address}: { address: string }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
         */
        fee?: number;
     ...
     */
    query_vesting_info: ({address, index}: { address: string; index: u64 }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
         */
        fee?: number;
     ...
     */
    query_all_vesting_info: ({address}: { address: string }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
         */
        fee?: number;
     ...
     */
    query_available_to_claim: ({address, index}: { address: string; index: u64 }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
         */
        fee?: number;
