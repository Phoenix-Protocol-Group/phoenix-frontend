...
export const networks = {
  testnet: {
    ...
    contractId: "CAFBHY7N7CPNC42S4CC2QDDPYJVI3TVAE6SUMCCTGW6YQ3R5BG57E7WB",
  }
} as const
...
export interface Client {
   ...
   */
  balance_of: ({account, id}: {account: string, id: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  balance_of_batch: ({accounts, ids}: {accounts: Array<string>, ids: Array<u64>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_approval_for_all: ({operator, approved}: {operator: string, approved: boolean}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_approval_for_transfer: ({operator, nft_id, approved}: {operator: string, nft_id: u64, approved: boolean}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  is_approved_for_transfer: ({owner, operator, nft_id}: {owner: string, operator: string, nft_id: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  safe_transfer_from: ({sender, from, to, id, transfer_amount}: {sender: string, from: string, to: string, id: u64, transfer_amount: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  safe_batch_transfer_from: ({sender, from, to, ids, amounts}: {sender: string, from: string, to: string, ids: Array<u64>, amounts: Array<u64>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  mint: ({sender, to, id, amount}: {sender: string, to: string, id: u64, amount: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  mint_batch: ({sender, to, ids, amounts}: {sender: string, to: string, ids: Array<u64>, amounts: Array<u64>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  burn: ({sender, from, id, amount}: {sender: string, from: string, id: u64, amount: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  burn_batch: ({sender, from, ids, amounts}: {sender: string, from: string, ids: Array<u64>, amounts: Array<u64>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_uri: ({sender, id, uri}: {sender: string, id: u64, uri: Buffer}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_collection_uri: ({sender, uri}: {sender: string, uri: Buffer}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAAAwAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAAARuYW1lAAAAEAAAAAAAAAAGc3ltYm9sAAAAAAAQAAAAAQAAA+kAAAPtAAAAAAAAB9AAAAANQ29udHJhY3RFcnJvcgAAAA==",
