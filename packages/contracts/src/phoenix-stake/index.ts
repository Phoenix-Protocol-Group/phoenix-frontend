...
export const networks = {
  testnet: {
    ...
    contractId: "CCQQUMU4NCEXUNG7YDM56TRH4MEWPVF3ORUYLSREALEBAVI6I72FNKVN",
  }
} as const

export type DistributionDataKey = {tag: "RewardHistory", values: readonly [string]} | {tag: "TotalStakedHistory", values: void};
...
export interface Client {
   ...
   */
  initialize: ({admin, lp_token, min_bond, min_reward, manager, owner, max_complexity}: {admin: string, lp_token: string, min_bond: i128, min_reward: i128, manager: string, owner: string, max_complexity: u32}, options?: {
    /**
   ...
   */
  bond: ({sender, tokens}: {sender: string, tokens: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  unbond: ({sender, stake_amount, stake_timestamp}: {sender: string, stake_amount: i128, stake_timestamp: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  create_distribution_flow: ({sender, asset}: {sender: string, asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  distribute_rewards: ({sender, amount, reward_token}: {sender: string, amount: i128, reward_token: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  withdraw_rewards: ({sender}: {sender: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  query_staked: ({address}: {address: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  query_withdrawable_rewards: ({user}: {user: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAABwAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAAAhscF90b2tlbgAAABMAAAAAAAAACG1pbl9ib25kAAAACwAAAAAAAAAKbWluX3Jld2FyZAAAAAAACwAAAAAAAAAHbWFuYWdlcgAAAAATAAAAAAAAAAVvd25lcgAAAAAAABMAAAAAAAAADm1heF9jb21wbGV4aXR5AAAAAAAEAAAAAA==",
