...
export interface Client {
   ...
   */
  distribute_rewards: (
    { amount, reward_token }: { amount: i128; reward_token: string },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "",
        ...
        "AAAAAAAAAAAAAAASZGlzdHJpYnV0ZV9yZXdhcmRzAAAAAAACAAAAAAAAAAZhbW91bnQAAAAAAAsAAAAAAAAADHJld2FyZF90b2tlbgAAABMAAAAA",
