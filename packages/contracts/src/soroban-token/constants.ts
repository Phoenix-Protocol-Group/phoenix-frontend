...
/**
 * The Soroban contract ID for the soroban-token-contract contract.
 */
export const CONTRACT_ID = '0'

/**
 * The Soroban contract ID for the soroban-token-contract contract, in hex.
