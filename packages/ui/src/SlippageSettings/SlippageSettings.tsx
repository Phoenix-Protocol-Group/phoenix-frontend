...
import { Box, FormControl, FormControlLabel, FormLabel, Grid, IconButton, Input, Radio, RadioGroup, Typography } from "@mui/material";
...
const SlippageSettings = ({options, selectedOption, onClose, onChange}: SlippageOptionsProps) => {
