                  ...
                  handleSort={(column: string) => {
                    props.setSort({
                      column: column as
                        ...
                        | "forSale",
                      direction:
                        props.activeSort.column === column &&
                        props.activeSort.direction === "desc"
                          ? "asc"
                          : "desc",
                    });
                  }}
            ...
            {props.entries.length ? (
              ...
              >
                ...
                >
                  ...
                  >
                    {props.searchTerm
                      ? `No collections match "${props.searchTerm}". Try adjusting your search criteria.`
                      : "Collections will appear here once they are available. Check back soon!"}
                  </Typography>
                </Box>
              </motion.div>
            )}
