        ...
        >
          ...
          <Box
            sx={{
              ...
              display: "flex",
              flexDirection: "column",
              // Project-consistent scrollbar styling (Firefox)
              scrollbarWidth: "thin",
              scrollbarColor: "#E2491A #1B1B1B",
              // Project-consistent scrollbar styling (Chrome, Edge, Safari)
              "&::-webkit-scrollbar": {
                width: "4px",
              },
          ...
          >
            <List>
              <ListSubheader
                sx={{
                  ...
                  // Responsive background - styled on small screens, transparent on larger screens
                  background: {
                    xs: `linear-gradient(135deg, rgba(249, 115, 22, 0.08) 0%, rgba(249, 115, 22, 0.04) 100%)`,
                    md: "transparent",
                  },
                  // Add border and styling for small screens
                  border: {
                    xs: `1px solid rgba(249, 115, 22, 0.2)`,
                    md: "none",
                  },
                  borderRadius: {
                    xs: borderRadius.md,
                  ...
                  margin: {
                    xs: `0 ${spacing.sm} ${spacing.lg} ${spacing.sm}`,
                    md: `0 0 ${spacing.lg} 0`,
                  },
                  // Add subtle box shadow for better separation on small screens
                  boxShadow: {
                  ...
                  fontWeight: {
                    xs: typography.fontWeights.medium,
                    md: typography.fontWeights.regular,
                  },
                  // Add backdrop blur for small screens
                  backdropFilter: {
                    xs: "blur(8px)",
                    md: "none",
                  },
            ...
            {/* Bottom Items - Now inside the scrollable container */}
            {bottomItems && (
              <Box
                sx={{
