...
class PhoenixXlmUsdxStrategy implements Strategy {
  private metadata: StrategyMetadata = {
    id: "phoenix-provide-liquidity-xlm-usdx",
    providerId: "phoenix-xlm-usdx",
    name: "Provide Liquidity to XLM-USDx",
    description: "Provide liquidity to the XLM-USDx pair and earn PHO rewards",
    assets: [],
    tvl: 0,
    apr: 0,
    rewardToken: {
  ...
  private async initialize(): Promise<void> {
    try {
      ...
      console.log("PhoenixXlmUsdxStrategy initialized successfully");
    } catch (error) {
      console.error("Failed to initialize PhoenixXlmUsdxStrategy:", error);
    }
  }
...
export default PhoenixXlmUsdxStrategy;
