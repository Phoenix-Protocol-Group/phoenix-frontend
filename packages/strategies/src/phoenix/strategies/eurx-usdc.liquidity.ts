...
class PhoenixEurxUsdcStrategy implements Strategy {
  private metadata: StrategyMetadata = {
    id: "phoenix-provide-liquidity-eurx-usdc",
    providerId: "phoenix-eurx-usdc",
    name: "Provide Liquidity to EURx-USDC",
    description: "Provide liquidity to the EURx-USDC pair and earn PHO rewards",
    assets: [],
    tvl: 0,
    apr: 0,
    rewardToken: {
  ...
  private async initialize(): Promise<void> {
    try {
      ...
      console.log("PhoenixEurxUsdcStrategy initialized successfully");
    } catch (error) {
      console.error("Failed to initialize PhoenixEurxUsdcStrategy:", error);
    }
  }
...
export default PhoenixEurxUsdcStrategy;
