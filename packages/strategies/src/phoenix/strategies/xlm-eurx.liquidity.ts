...
class PhoenixXlmEurxStrategy implements Strategy {
  private metadata: StrategyMetadata = {
    id: "phoenix-provide-liquidity-xlm-eurx",
    providerId: "phoenix-xlm-eurx",
    name: "Provide Liquidity to XLM-EURx",
    description: "Provide liquidity to the XLM-EURx pair and earn PHO rewards",
    assets: [],
    tvl: 0,
    apr: 0,
    rewardToken: {
  ...
  private async initialize(): Promise<void> {
    try {
      ...
      console.log("PhoenixXlmEurxStrategy initialized successfully");
    } catch (error) {
      console.error("Failed to initialize PhoenixXlmEurxStrategy:", error);
    }
  }
...
export default PhoenixXlmEurxStrategy;
