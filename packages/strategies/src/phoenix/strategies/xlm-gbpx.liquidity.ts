...
class PhoenixXlmGbpxStrategy implements Strategy {
  private metadata: StrategyMetadata = {
    id: "phoenix-provide-liquidity-xlm-gbpx",
    providerId: "phoenix-xlm-gbpx",
    name: "Provide Liquidity to XLM-GBPx",
    description: "Provide liquidity to the XLM-GBPx pair and earn PHO rewards",
    assets: [],
    tvl: 0,
    apr: 0,
    rewardToken: {
  ...
  private async initialize(): Promise<void> {
    try {
      ...
      console.log("PhoenixXlmGbpxStrategy initialized successfully");
    } catch (error) {
      console.error("Failed to initialize PhoenixXlmGbpxStrategy:", error);
    }
  }
...
export default PhoenixXlmGbpxStrategy;
