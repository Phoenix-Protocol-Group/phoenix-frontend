...
import { SorobanContextType } from "../../providers/walletProvider/soroban/SorobanContext";
...
// useContractSign is a hook that returns a function that can be used to
...
export function useContractSign<E = Error>(
  ...
  // we don't need anymore a useCallback hook. Convert useContractSign to a
