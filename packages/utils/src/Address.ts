...
export class Address {
   ...
   * @returns {Address}
   */
  static fromScVal(scVal: xdr.ScVal) {
   ...
   * @returns {Address}
   */
  static fromScAddress(scAddress: xdr.ScAddress) {
    switch (scAddress.switch().name) {
